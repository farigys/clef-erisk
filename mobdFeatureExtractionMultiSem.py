...
rootD = "/home/farig/Desktop/eRisk@CLEF2017 - released training data_backup/"
userIdFile = open(rootD + "risk_golden_truth.txt")
writefile = open(rootD + "/metamapFeaturesTestAll.txt", 'a+')  #change here.................................
...
for userId in totalUserList:
    raiseFlag = 0
    #writefile1 = open(rootD + "metamapOutputs/metamapOutputs/" + userId + ".txt", 'a+') #change here............................
    userCount = userCount + 1
    #if userId in skiplist: 
	#raiseFlag = 1
    #if userCount == userEndLimit:
	#break
    #if userCount < userStartLimit:
	#continue
    writefile1 = open(rootD + "metamapOutputs/metamapOutputs/" + userId + ".txt", 'a+') #change here............................
	...
	#rootDir = rootD + "chunk 10 analysis/chunk " + str(chunk) + "/" #change here...................................
	    ...
	    stringToMap = root[i][0].text + ". " + root[i][3].text
